...
func main() {
	...
	file := service.Intelligence{
		...
		GradeInfo:               "None",
		AllocationInfo:          "None",
		SpecialItemInfo:         "None",
		SpecialGroupInfo:        "None",
		TaskEstablishAssignInfo: "None",
		TaskReceivedInfo:        "None",
		ResearchLogInfo:         "None",
		ResultFeedbackInfo:      "None",
		EvaluationInfo:          "None",
		ReportInfo:              "None",
		ResultAuditInfo:         "None",
	}
